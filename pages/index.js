      ...
      <main className='p-4 dark:bg-gray-900 dark:text-white'>
        <section>
          <nav className='flex items-center justify-between max-w-7xl m-auto mb-12'>
            <h1 className='font-semibold text-xl text-left py-4 cursor-pointer sm:text-3xl'>DevByMohaimin</h1>
          ...
          <div className='text-center '>
            <h1 className='text-cyan-600 font-semibold text-5xl py-2 md:text-7xl md:mt-20'>Mohaimin Islam</h1>
            <h2 className='font-semibold text-2xl pb-4'>Front-end Designer and Developer</h2>
            <p className='text-gray-500 font-normal text-lg md:text-xl max-w-lg mx-auto'>I am a programmer mohaimin and I am learning web development . Still now I am a Front-end Developer. But in future I wanted to become e Full-Stack Developer.</p>
          </div>
    ...
    {/* another card */}
        ...
        <section >
          <div className='max-w-5xl mx-auto my-8 '>
            ...
            <p className='text-gray-500 font-normal text-xl text-left py-2 xl:text-center'>I am a programmer mohaimin and I am learning web development . Still now I am a <span className='text-teal-500 font-semibold'>Front-end Developer</span>, But in future I wanted to become e Full-Stack Developer. I have own plan and I create a Company near future. I will help you to make <span className='text-teal-500 font-semibold'>your dream</span> on your project.</p>
            <p className='text-gray-500 font-normal text-xl text-left py-2 xl:text-center' >I will help you to make your dream on your project. I wanted to become e <span className='text-teal-500 font-semibold'> Full-Stack Developer</span>.</p>
          </div>
        ...
        <div className='flex items-center justify-center text-4xl space-x-8 my-8'>
          ...
          <p className='text-center text-xl'>Developed by  <AiFillCopyrightCircle className='inline-block text-2xl'/> Mohaimin_  2022</p>
        </footer>
      </main>
    </div>
  )
